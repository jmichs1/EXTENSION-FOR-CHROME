// Early-inject script: runs at document_start to monkey-patch fetch
// BEFORE Whatnot makes its initial GraphQL calls.
// This captures break IDs from LiveStreamExplore and other early API calls.
(function() {
  if (document.getElementById('__bo_net_intercept')) return;
